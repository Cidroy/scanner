...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	methods: {
		...
		login: function login() {
			...
			this.logging = true;
			this.$store.dispatch('ninjaLogin', this.email).then(function (data) {
				return _this.gotoScan();
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	methods: {
					...
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								_context.prev = 0;
								_context.next = 3;
								return _this.$app.barcodeScanner();
							...
							case 3:
								...
								console.log(ticket);
								ticket = ticket.text;
								_this.scanl.processing = true;
								_context.next = 9;
								return _this.$store.dispatch('ninjaScan', ticket);

							case 9:
								response = _context.sent;

								_this.scanl.processing = false;
								response.verifier.time.date = Date.parse(response.verifier.time.date);
								_this.response = response;
								if (response['scan-type'] === "denied") _this.scanl.error = true;else if (response['scan-type'] === "verified") _this.scanl.success = true;
								_context.next = 20;
								break;
		...
		logout: function logout() {
				...
				return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
					while (1) {
						switch (_context2.prev = _context2.next) {
							case 0:
								_context2.next = 2;
								return _this2.$store.dispatch('ninjaLogout');
			...
			this.scanl.error = false, this.scanl.success = false, this.response = {};
			this.$store.dispatch('ninjaRefresh');
		}
	},
	created: function created() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuex_persistedstate__ = __webpack_require__(522);
...
var getModules = function getModules() {
	var files = __webpack_require__(523);
	var mods = {};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
var files = __webpack_require__(643);
var modules = {};
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuetify__ = __webpack_require__(471);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuetify___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vuetify__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuetify_dist_vuetify_css__ = __webpack_require__(472);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_timeago__ = __webpack_require__(474);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_transitions_transitions_css__ = __webpack_require__(475);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_transitions_transitions_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__modules_transitions_transitions_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__App__ = __webpack_require__(476);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__router__ = __webpack_require__(479);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__store__ = __webpack_require__(225);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__modules_directives__ = __webpack_require__(637);
...
for (var i in __WEBPACK_IMPORTED_MODULE_8__modules_directives__["a" /* default */]) {
	if (__WEBPACK_IMPORTED_MODULE_8__modules_directives__["a" /* default */].hasOwnProperty(i)) __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].directive(i, __WEBPACK_IMPORTED_MODULE_8__modules_directives__["a" /* default */][i]);
}

__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].use(__WEBPACK_IMPORTED_MODULE_3_vue_timeago___default.a, {
	name: "timeago", // component name, `timeago` by default
	locale: "en-US",
	locales: {
		// you will need json-loader in webpack 1
		"en-US": __webpack_require__(642)
	}
});
...
__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].prototype.$app = __webpack_require__(264).default;
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
	...
	store: __WEBPACK_IMPORTED_MODULE_7__store__["default"],
...
__WEBPACK_IMPORTED_MODULE_6__router__["a" /* default */].afterEach(function (to, from, next) {
	setTimeout(function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_120e24a2_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(478);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_120e24a2_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* default */],
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',{attrs:{"dark":""}},[_c('transition',{attrs:{"name":"slide-y-transition"}}),_vm._v(" "),_c('main',[_c('transition',{attrs:{"name":"slide-x-transition"}},[(false)?_c('v-dialog',{attrs:{"value":_vm.$root.router_loading,"fullscreen":"","transition":"fadeIn","overlay":false}},[_c('v-card',[_c('v-container',{attrs:{"fill-height":""}},[_c('v-layout',[_vm._v(" \n\t\t\t\t\t\t\tLoading ...\n\t\t\t\t\t\t\t")])],1)],1)],1):_vm._e()],1),_vm._v(" "),_c('transition',{attrs:{"name":"slide-x-transition"}},[_c('router-view')],1)],1)],1)}
var staticRenderFns = []
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages__ = __webpack_require__(481);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_errors_404__ = __webpack_require__(519);
...
var files = __webpack_require__(488);
var pages = [];
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Hello_vue__ = __webpack_require__(211);
...
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_376e65ea_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Index_vue__ = __webpack_require__(493);
var normalizeComponent = __webpack_require__(74)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_376e65ea_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticStyle:{"width":"100vh"}},[_vm._m(0),_vm._v(" "),(_vm.$store.getters.ninjaLoggedin)?_c('div',[_c('v-card',{staticClass:"pa-4"},[_c('v-card-text',[_vm._v("Please wait ...")])],1)],1):_c('div',{staticStyle:{"display":"flex","flex-flow":"column","height":"100vh","justify-content":"center"}},[_c('v-card',{staticClass:"elevation-15 rounded-border main"},[(!_vm.logging)?_c('div',[_c('v-tabs',{attrs:{"grow":"","centered":true},model:{value:(_vm.active),callback:function ($$v) {_vm.active=$$v},expression:"active"}},[_c('v-tabs-bar',{staticClass:"indigo darken-2",attrs:{"dark":""}},[_vm._l((_vm.tabs),function(tab){return _c('v-tabs-item',{key:tab,attrs:{"href":'#' + tab,"ripple":""}},[_vm._v("\n                  "+_vm._s(tab)+"\n                ")])}),_vm._v(" "),_c('v-tabs-slider',{attrs:{"color":"yellow"}})],2),_vm._v(" "),_c('v-tabs-items',_vm._l((_vm.tabs),function(tab){return _c('v-tabs-content',{key:tab,attrs:{"id":tab}},[(tab=='Register')?_c('v-card',{attrs:{"flat":""}},[_c('v-card-text',[_c('v-flex',{attrs:{"xs12":""}},[_c('v-form',{ref:"register",refInFor:true,model:{value:(_vm.f_register),callback:function ($$v) {_vm.f_register=$$v},expression:"f_register"}},[_c('v-text-field',{attrs:{"name":"username","rules":_vm.rules.username,"label":"username","single-line":"","prepend-icon":"account_circle"},model:{value:(_vm.username),callback:function ($$v) {_vm.username=$$v},expression:"username"}}),_vm._v(" "),_c('v-text-field',{attrs:{"name":"email","rules":_vm.rules.email,"label":"Email","single-line":"","prepend-icon":"email"},model:{value:(_vm.email),callback:function ($$v) {_vm.email=$$v},expression:"email"}})],1)],1),_vm._v(" "),_c('v-btn',{staticClass:"white--text",attrs:{"block":"","color":"indigo"},on:{"click":_vm.register}},[_vm._v("Register")])],1)],1):(tab=='Login')?_c('v-card',{attrs:{"flat":""}},[_c('v-card-text',[_c('v-flex',{attrs:{"xs12":""}},[_c('v-form',{ref:"login",refInFor:true,model:{value:(_vm.f_login),callback:function ($$v) {_vm.f_login=$$v},expression:"f_login"}},[_c('v-text-field',{attrs:{"name":"email","rules":_vm.rules.email,"label":"Email","single-line":"","prepend-icon":"email"},model:{value:(_vm.email),callback:function ($$v) {_vm.email=$$v},expression:"email"}})],1)],1),_vm._v(" "),_c('v-btn',{staticClass:"white--text",attrs:{"block":"","color":"indigo"},on:{"click":_vm.login}},[_vm._v("Login")])],1)],1):_vm._e()],1)}))],1)],1):_c('v-layout',{staticClass:"pa-4",attrs:{"align-center":"","justify-center":"","row":"","wrap":""}},[_c('v-flex',{attrs:{"xs12":""}},[_c('v-progress-circular',{staticStyle:{"display":"block","margin":"auto"},attrs:{"indeterminate":"","color":"primary","size":70}})],1),_vm._v(" "),_c('v-flex',{staticClass:"text-xs-center pt-3",attrs:{"xs12":""}},[_vm._v("\n\t\t\t\t\t  "+_vm._s(_vm.logging_message)+"\n\t\t\t\t")])],1)],1)],1)])}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"page-bg"},[_c('img',{attrs:{"src":"static/images/13.jpg","alt":""}})])}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Scan_vue__ = __webpack_require__(213);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_16c47cd6_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Scan_vue__ = __webpack_require__(518);
function injectStyle (ssrContext) {
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Scan_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_16c47cd6_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Scan_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticStyle:{"width":"100vh"}},[_vm._m(0),_vm._v(" "),(!_vm.$store.getters.ninjaLoggedin)?_c('div',[_c('v-card',{staticClass:"pa-4"},[_c('v-card-text',[_vm._v("Please wait ...")])],1)],1):_c('div',[_c('v-btn',{staticClass:"white--text",staticStyle:{"margin-top":"10vh"},attrs:{"large":"","block":"","color":"orange"},on:{"click":_vm.scan}},[_c('v-icon',[_vm._v("gradient")]),_vm._v(" Scan")],1),_vm._v(" "),_c('v-btn',{staticClass:"white--text",staticStyle:{"margin-top":"10vh"},attrs:{"large":"","block":"","color":"indigo"},on:{"click":_vm.logout}},[_c('v-icon',[_vm._v("exit_to_app")]),_vm._v(" Logout")],1),_vm._v(" "),_c('v-card',[_c('v-list',{staticStyle:{"margin-top":"140px"},attrs:{"subheader":""}},[_c('v-subheader',[_vm._v("Scanned ("+_vm._s(_vm.$store.getters.ninjaScans.length)+") :")]),_vm._v(" "),_vm._l((_vm.$store.getters.ninjaScans),function(item){return _c('v-list-tile',{key:item.ticket,attrs:{"avatar":""}},[_c('v-list-tile-avatar',[_c('img',{attrs:{"src":"/static/images/ninja.png"}})]),_vm._v(" "),_c('v-list-tile-content',[_c('v-list-tile-title',{domProps:{"innerHTML":_vm._s(item.client)}})],1)],1)})],2)],1)],1),_vm._v(" "),_c('v-bottom-sheet',{model:{value:(_vm.scanl.processing),callback:function ($$v) {_vm.$set(_vm.scanl, "processing", $$v)},expression:"scanl.processing"}},[_c('v-card',[_c('v-card-title',{staticClass:"headline indigo white--text",attrs:{"align-center":""}},[_c('v-spacer'),_vm._v(" Processing..."),_c('v-spacer')],1),_vm._v(" "),_c('v-layout',{staticClass:"pt-4",attrs:{"align-center":"","justify-center":""}},[_c('v-progress-circular',{attrs:{"indeterminate":"","size":70,"width":3,"color":"indigo"}})],1)],1)],1),_vm._v(" "),_c('v-bottom-sheet',{attrs:{"persistent":""},model:{value:(_vm.scanl.success),callback:function ($$v) {_vm.$set(_vm.scanl, "success", $$v)},expression:"scanl.success"}},[_c('v-card',[_c('v-card-title',{staticClass:"headline green white--text"},[_c('v-spacer'),_vm._v(" "),_c('v-spacer'),_vm._v(" VERIFIED"),_c('v-spacer'),_vm._v(" "),_c('v-icon',{attrs:{"x-large":"","color":"white"}},[_vm._v("check")])],1),_vm._v(" "),_c('v-card-text',[_c('div',{staticClass:"info--text"},[_vm._v("Ticket ID: ")]),_vm._v(" "),_c('div',{staticStyle:{"font-family":"San serif","font-weight":"bold"}},[_vm._v("Name: "+_vm._s(_vm.response.user?_vm.response.user.name:''))]),_vm._v(" "),_c('div',{staticStyle:{"font-family":"","font-weight":"bold"}},[_vm._v("Email: "+_vm._s(_vm.response.user?_vm.response.user.email:''))])]),_vm._v(" "),_c('v-card-actions',{staticClass:"pt-5"},[_c('v-btn',{staticStyle:{"margin-left":"0","width":"100%"},attrs:{"color":"info"},nativeOn:{"click":function($event){_vm.done($event)}}},[_vm._v("Done")])],1)],1)],1),_vm._v(" "),_c('v-bottom-sheet',{attrs:{"persistent":""},model:{value:(_vm.scanl.error),callback:function ($$v) {_vm.$set(_vm.scanl, "error", $$v)},expression:"scanl.error"}},[_c('v-card',[_c('v-card-title',{staticClass:"headline red white--text"},[_c('v-spacer'),_vm._v(" "),_c('v-spacer'),_vm._v(" DENIED"),_c('v-spacer'),_vm._v(" "),_c('v-icon',{attrs:{"x-large":"","color":"white"}},[_vm._v("error")])],1),_vm._v(" "),_c('v-card-title',{staticClass:"grey darken-2 white--text text-xs-center pa-1"},[_vm._v("The Ticket has been used")]),_vm._v(" "),_c('v-card-text',[_c('div',{staticClass:"info--text"},[_vm._v("Ticket ID: ")]),_vm._v(" "),_c('div',{staticStyle:{"font-family":"San serif","font-weight":"bold"}},[_vm._v("Name: "+_vm._s(_vm.response.user?_vm.response.user.name:''))]),_vm._v(" "),_c('div',{staticStyle:{"font-family":"","font-weight":"bold"}},[_vm._v("Email: "+_vm._s(_vm.response.user?_vm.response.user.email:''))]),_vm._v(" "),_c('div',{staticStyle:{"font-family":"","font-weight":"bold"}},[_vm._v("Time: "),_c('timeago',{attrs:{"since":_vm.response.verifier?_vm.response.verifier.time.date:false}})],1),_vm._v(" "),_c('div',{staticStyle:{"font-family":"","font-weight":"bold"}},[_vm._v("By: "+_vm._s(_vm.response.verifier?_vm.response.verifier.name:'')+" ")])]),_vm._v(" "),_c('v-card-actions',{staticClass:"pt-5"},[_c('v-btn',{staticStyle:{"margin-left":"0","width":"100%"},attrs:{"color":"info"},nativeOn:{"click":function($event){_vm.done($event)}}},[_vm._v("Done")])],1)],1)],1)],1)}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"page-bg"},[_c('img',{attrs:{"src":"static/images/13.jpg","alt":""}})])}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_404_vue__ = __webpack_require__(224);
/* unused harmony namespace reexport */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__scripts_maple_request__ = __webpack_require__(525);
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	actions: {
		ninjaRefresh: function ninjaRefresh(_ref) {
			var commit = _ref.commit,
			    state = _ref.state;
			return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
				if (state.loggedin) {
					__WEBPACK_IMPORTED_MODULE_1__scripts_maple_request__["a" /* default */].post("eventninjaz/rangholic", "login", { email: state.user.email }).then(function (data) {
						data = data.response;
		...
		ninjaScan: function ninjaScan(_ref2, ticket) {
			var commit = _ref2.commit,
			    state = _ref2.state;
			return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
				__WEBPACK_IMPORTED_MODULE_1__scripts_maple_request__["a" /* default */].post("eventninjaz/rangholic", "verify", { ticket: ticket, scanner: state.ninjaId }).then(function (data) {
					data = data.response;
					if (data.type === "success") resolve(data);else reject(data);
				}).catch(function (error) {
					return reject({
						type: "error",
		...
		ninjaRegister: function ninjaRegister(_ref3, credentials) {
		...
		ninjaLogin: function ninjaLogin(_ref4, email) {
		...
		ninjaLogout: function ninjaLogout(_ref5) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_slicedToArray__ = __webpack_require__(526);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_asyncToGenerator__ = __webpack_require__(153);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_es6_request__ = __webpack_require__(533);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__details__ = __webpack_require__(636);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty__ = __webpack_require__(638);
...
//# sourceMappingURL=app.67c9e7d1d5d4cc7af9c9.js.map